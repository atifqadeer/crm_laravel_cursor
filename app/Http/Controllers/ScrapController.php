...
class ScrapController extends Controller
{
    ...
    public function __construct()
    {
        $this->middleware('permission:scrap-index')->only([
            'importIndex', 'importJobs', 'officeIndex', 'unitIndex', 'salesIndex',
            'getScrappedOffices', 'getScrappedUnits', 'getScrappedSales',
            'scrappedOfficeDestroy', 'scrappedUnitDestroy', 'scrappedSaleDestroy',
            'scrappedOfficeRestore', 'scrappedUnitRestore', 'scrappedSaleRestore',
            'scrappedSaleApprove', 'scrappedUnitApprove', 'scrappedOfficeApprove',
            'getSaleEmails', 'getBulkEmailTemplate', 'getBulkOfficesEmailTemplate',
            'sendEmailToOffices', 'sendBulkEmailsToOffices',
        ]);
    }
