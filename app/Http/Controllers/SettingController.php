...
class SettingController extends Controller
{
    public function __construct()
    {
        $this->middleware('permission:administrator-setting-index')->only([
            'index', 'create', 'store', 'edit', 'update', 'destroy', 'show', 'getSettings',
            'saveSmtpSettings', 'saveGeneralSettings', 'saveGoogleSettings', 'saveNotificationSettings',
            'saveSmsSettings', 'saveProfileSettings', 'deleteSmtp', 'saveDialingSettings',
            'saveScraperSettings', 'runScraperActor', 'deleteScraperActor',
        ]);
