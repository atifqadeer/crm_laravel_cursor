...
@section('script')
    ...
    <script>
            ...
            const table = $('#applicants_table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.title_filters = (typeof window.getVisibleListingTitleIds === 'function' ? window.getVisibleListingTitleIds() : currentTitleFilters);
        ...
        $(document).on('click', '.export-btn', function(e) {
            ...
            url.searchParams.set('status_filter', (statusFilter === 'all' || statusFilter === '') ? '' : statusFilter);
            url.searchParams.set('type_filter', (typeFilter === 'all types' || typeFilter === 'all' || typeFilter === '') ? '' : typeFilter);
